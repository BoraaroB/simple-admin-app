...
const folder = 'log/';
const DATE_PATTERN = config.LOG_DATE_PATTERN || 'YYYY-MM-DD';
const KEEP_LOGS_DAYS = config.LOG_KEEP_LOGS_DAYS || 7;
...
const appLogger = createLogger({ level: config.LOG_LEVEL });
